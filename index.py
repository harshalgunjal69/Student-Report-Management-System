...
def display(table_data, choice):
    """
    Takes in the table data and choice prints a table out of it.
    """
    table = PrettyTable()
...
def view_all(_class):
    """
    Takes in the students' class as an argument and views all data in the form of a table.
    """
    flag = 0
    choice = 1
    try:
...
def check(_class, _rollno):
    """
    Takes in the class and roll non as arguments and views the details of a single student.
    """
    flag = 0
    choice = 2
    try:
...
def topper(_class):
    """
    Takes in the class as argument and views the details of top 3 students in the class.
    """
    flag = 0
    choice = 3
    try:
...
def add(list_of_data):
    """
    Takes in the list of all the data of a student as argument and adds the details to the table.
    """
    flag = 0
    try:
...
def update(_class, _rollno, adm_no):
    """
    Takes in the class, roll no. amd adm no. as arguments and updates the details of a single student.
    """
    print(
...
def _update(new, value, _class, _rollno, adm_no):
    """
    Takes in the updated value, name of value, class, roll no. and adm no. of the students and updates the value.
    """
    flag = 0
    try:
...
def delete(_class, _rollno):
    """
    Takes in the class and roll non as arguments and deletes the details of a single student.
    """
    flag = 0
    try:
